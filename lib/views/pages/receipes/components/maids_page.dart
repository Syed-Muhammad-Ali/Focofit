...
class MaidsPage extends StatefulWidget {
  const MaidsPage({super.key});

  @override
  State<MaidsPage> createState() => _MaidsPageState();
}

class _MaidsPageState extends State<MaidsPage> {
  ...
  Widget build(BuildContext context) {
    return _buildGrid(demoRecipes.take(2).toList());
  }
