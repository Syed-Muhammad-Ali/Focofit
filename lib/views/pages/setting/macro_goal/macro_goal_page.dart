...
class MacroGoalPage extends StatelessWidget {
  const MacroGoalPage({super.key});
          ...
          Column(
            children: [
              ...
              DiaryContainerTile(
                child: Column(
                  children: [
                    BreakfastWidget(title: 'Breakfast', gram: 'g'),
                    BreakfastWidget(title: 'Lunch', gram: 'g'),
                    BreakfastWidget(title: 'Dinner', gram: 'g'),
                    BreakfastWidget(
                      title: 'Snacks',
                      gram: 'g',
                      showDivider: false,
