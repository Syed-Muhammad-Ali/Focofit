...
import 'package:focofit/views/pages/adding_excercises/result_correction_register_exercise/result_correction__register_exercise_page.dart';
...
class RegisterExerciseScreen extends StatefulWidget {
  const RegisterExerciseScreen({super.key});
