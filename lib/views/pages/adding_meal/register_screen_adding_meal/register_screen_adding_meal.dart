...
import '../../adding_excercises/result_correction_register_exercise/result_correction__register_exercise_page.dart';

class RegisterScreenAddingMeal extends StatefulWidget {
  const RegisterScreenAddingMeal({super.key});

  @override
  State<RegisterScreenAddingMeal> createState() =>
      RegisterScreenAddingMealState();
}

class RegisterScreenAddingMealState extends State<RegisterScreenAddingMeal> {
  bool isFav = false;
              ...
              child: Row(
                children: [
                  Expanded(
                    child: AppButton(
                      ontap: () {
                        Get.to(() => ResultCorrectionRegisterExercisePage());
                      },
                      label: 'To correct',
